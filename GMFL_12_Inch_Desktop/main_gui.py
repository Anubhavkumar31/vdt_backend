...
from extras.graphs import plot_erf, plot_psafe, plot_depth, plot_orientation
from extras.Defects import (plot_metal_loss, plot_sensor_percentage, plot_temperature)# Metal Loss and Sensor Loss Plot functions
